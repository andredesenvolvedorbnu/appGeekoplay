  ...
  return (
    <div className="min-h-screen bg-geek-bg text-slate-100">
      <header className="fixed z-40 inset-x-0 top-0 h-14 border-b border-geek-line bg-[#0d1015]/95 backdrop-blur flex items-center px-4 gap-4">
        ...
        <div className="ml-auto flex items-center gap-3"><Link href="/mensagens"><Mail size={18}/></Link><Link href="/notificacoes"><Bell size={18}/></Link><Link href="/perfil" className="h-8 w-8 rounded-full bg-gradient-to-br from-orange-400 to-purple-600" aria-label="Perfil"/></div>
      </header>
      <aside className="hidden lg:block fixed left-0 top-14 bottom-0 w-64 border-r border-geek-line bg-[#0d1015] p-3 overflow-y-auto">
        ...
        <div className="border-t border-geek-line my-5"/><p className="px-3 text-[10px] tracking-[.2em] text-slate-500 font-bold mb-2">INTERESSES</p>
