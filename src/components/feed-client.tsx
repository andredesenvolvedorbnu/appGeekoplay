...
export function FeedClient(){
 ...
 async function createPost(){
  ...
  try{
   ...
   const moderation=await checkModeration('post',content.trim(),selectedFile,category);
