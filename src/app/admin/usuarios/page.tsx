...
export default async function AdminUsuariosPage() {
  ...
  return <div className="mx-auto max-w-7xl space-y-5">
    <div><p className="text-sm font-bold text-geek-orange">ADMINISTRAÇÃO</p><h1 className="text-2xl font-black sm:text-3xl">Usuários</h1><p className="mt-2 text-sm text-slate-400">Gerencie contas, permissões e ações de parceria: concessão promocional de XP e impulsionamento cortesia de publicações.</p></div>
